            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    <v-list-item
                        class="px-2"
                        key="rentalSystems"
                        to="/rentalServices/rentalSystems"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
                    ...
                    <v-list-item
                        class="px-2"
                        key="reviewSystems"
                        to="/reviewServices/reviewSystems"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            { 
                ...
                description: '', 
                key: 'rentalSystems', 
                route: '/rentalServices/rentalSystems',
                ImageUrl: '',
            },
            { 
                title: 'ReviewSystem', 
                description: '', 
                key: 'reviewSystems', 
                route: '/reviewServices/reviewSystems',
                ImageUrl: '',
            },
            { 
                title: 'BookSystem', 
                description: '', 
                key: 'bookSystems', 
                route: '/bookServices/bookSystems',
                ImageUrl: '',
            },
            { 
                title: 'PointSystem', 
